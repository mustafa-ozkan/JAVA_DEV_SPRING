...
VALUES ('AMC Empire 25', '234 W 42nd St', '10036', 'United States', 'New York', 'New York'),
       ...
       ('AMC Village 7', '66 3rd Ave', '10003', 'United States', 'NewYork', 'New York');
...
VALUES (113, 'The Gentleman', 20.0, '2020-01-24 00:00:01', 'ACTIVE',
        'An American expat tries to sell off his highly profitable marijuana empire in London, triggering plots, schemes, bribery and blackmail in an attempt to steal hisdomain out from under him.',
        'REGULAR'),
...
VALUES ((SELECT m.id from movie m WHERE m.name = 'The Gentleman'),
       ...
       ((SELECT m.id from movie m WHERE m.name = 'Tenet'),
        (SELECT g.id from genre g WHERE g.name = 'Sci-Fi')),
       ((SELECT m.id from movie m WHERE m.name = 'Tenet'),
        (SELECT g.id from genre g WHERE g.name = 'Action')),
...
VALUES ('2020-12-05 20:00:00', 14, 15, (SELECT id
       ...
       ('2020-12-06 20:45:00', 9, 9, (SELECT id
                                      ...
                                      WHERE cinema_id =
                                        ...
                                        AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'Tenet')
                                      LIMIT 1),
        (SELECT id from user_account WHERE email = 'faith.p@email.com')),
