...
public class DataGenerator implements CommandLineRunner {
    ...
    public DataGenerator(MovieRepository movieRepository, CinemaRepository cinemaRepository, GenreRepository genreRepository, UserAccountRepository userAccountRepository, MovieCinemaRepository movieCinemaRepository, TicketRepository ticketRepository) {
    ...
    AccountDetail a1 = new AccountDetail("Josie D Story", "262  Lochmere Lane", "United States", "Kentucky", "LOUISVILLE", 35, "40289", UserRole.USER);
    AccountDetail a2 = new AccountDetail("Bernard P Fendley", "2903  Jarvis Street", "United States", "New York", "Buffalo", 28, "14211", UserRole.USER);
    AccountDetail a3 = new AccountDetail("Faith R Parsons", "4161  Alfred Drive", "United States", "New York", "Brooklyn", 47, "11226", UserRole.USER);
    AccountDetail a4 = new AccountDetail("Johnnie J Cannon", "2587  Logan Lane", "United States", "New York", "HOLTSVILLE", 47, "00544", UserRole.USER);
    AccountDetail a5 = new AccountDetail("Lawrence E Folkerts", "698  Clark Street", "United States", "New York", "Brentwood", 47, "11717", UserRole.USER);
    ...
    private void createUsers() {
        u1.setAccountDetail(a1);
        u2.setAccountDetail(a2);
        u3.setAccountDetail(a3);
        u4.setAccountDetail(a4);
        u5.setAccountDetail(a5);
        userAccountRepository.saveAll(Arrays.asList(u1, u2, u3, u4, u5));
    }
